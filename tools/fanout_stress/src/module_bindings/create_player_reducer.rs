...
pub trait create_player {
    ...
    fn create_player(&self, display_name: String) -> __sdk::Result<()> {
        self.create_player_then(display_name, |_, _| {})
    }
...
impl create_player for super::RemoteReducers {
    fn create_player_then(
        ...
        self.imp
            .invoke_reducer_with_callback(CreatePlayerArgs { display_name }, callback)
    }
}
