...
When built with `UE_WITH_REMOTE_OBJECT_HANDLE=1`, this enables the full DSTM pipeline:
...
**Status:** Plugin implemented and reviewed. Pending runtime testing with engine rebuild.