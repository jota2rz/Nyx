...
Start-Process $ue -ArgumentList "`"$proj`" -server -port=7777 -log -NOSTEAM -DedicatedServerId=server-1 -ZoneSide=west -DSTMGuidSeed=100000 -MultiServerListenPort=15000 -MultiServerNumServers=2 -MultiServerPeers=127.0.0.1:15001 -ABSLOG=`"C:\UE\Nyx\server1_log.txt`""
...
Start-Process $ue -ArgumentList "`"$proj`" -server -port=7778 -log -NOSTEAM -DedicatedServerId=server-2 -ZoneSide=east -DSTMGuidSeed=200000 -MultiServerListenPort=15001 -MultiServerNumServers=2 -MultiServerPeers=127.0.0.1:15000 -ABSLOG=`"C:\UE\Nyx\server2_log.txt`""
